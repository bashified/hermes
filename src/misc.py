...
def resolve_hostname(ip: str) -> str:
    ...
    # trying mDNS/NetBIOS name resolution on Windows
...
def vendor_from_mac(mac: str) -> str:
    ...
    oui = {
        "DCFB48": "Intel",    "F0D1A9": "Apple",   "A8BB50": "WiZ IoT",
        "88A29E": "Raspberry Pi",    "F0DCE2": "Apple",    "BC9FEF": "Apple",
        "E0D4E8": "Intel",    "B827EB": "Raspberry Pi", "DCA632": "Raspberry Pi",
        "001A11": "Google",   "94EB2C": "Google",
        "00E04C": "Realtek",  "4CCC6A": "MSI",
